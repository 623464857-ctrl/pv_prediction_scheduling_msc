...
| ------------ | --------------- | --------------- | ------------ | --------------- | ------- |
| LSTM         | 0.0260 ± 0.0021 | 0.0577 ± 0.0012 | 27.65 ± 2.79 | 0.9557 ± 0.0018 | 103.3   |
| BiLSTM       | 0.0249 ± 0.0016 | 0.0574 ± 0.0025 | 28.01 ± 1.61 | 0.9561 ± 0.0037 | 188.9   |
| CNN-LSTM     | 0.0254 ± 0.0004 | 0.0561 ± 0.0011 | 28.95 ± 0.11 | 0.9582 ± 0.0016 | 150.9   |
| CNN-BiLSTM   | 0.0263 ± 0.0002 | 0.0571 ± 0.0019 | 26.87 ± 0.93 | 0.9566 ± 0.0029 | 339.3   |
| MiniPatchTST | 0.0275 ± 0.0014 | 0.0590 ± 0.0014 | 28.98 ± 1.86 | 0.9537 ± 0.0022 | 84.4    |
...
- **最优模型**: BiLSTM (MAE=0.0249 ± 0.0016)

- **最差模型**: MiniPatchTST (MAE=0.0275)
...
![metrics_mae_bar](data\prediction\step4_optuna_hybrid\figures\h4\metrics_mae_bar.png)


![metrics_rmse_bar](data\prediction\step4_optuna_hybrid\figures\h4\metrics_rmse_bar.png)


![metrics_r2_bar](data\prediction\step4_optuna_hybrid\figures\h4\metrics_r2_bar.png)
