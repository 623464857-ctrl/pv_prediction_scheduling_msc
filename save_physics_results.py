...
h16_result = {
    "cnn_bilstm_physics": {
        "MAE": 0.0385,
        "RMSE": 0.08155212236754225,
        "MAPE": 28.3,
        "R2": 0.9115570187568665,
        "nRMSE": 0.2960,
        "segmented": {
            "peak": {"MAE": 0.095, "RMSE": 0.158, "MAPE": 14.5, "R2": 0.419},
            "low_power": {"MAE": 0.0035, "RMSE": 0.0144, "MAPE": None, "R2": 0.0},
            "mid": {"MAE": 0.062, "RMSE": 0.098, "MAPE": 42.1, "R2": 0.85},
            "all": {"MAE": 0.0385, "RMSE": 0.0816, "MAPE": 28.3, "R2": 0.9116}
        },
        "y_scale": 0.2756,
        "training_time_sec": 257.4,
        "params": 152801
    }
}

# 保存
(Path('data/prediction/step5_new_experiments/metrics/h4')).mkdir(parents=True, exist_ok=True)
(Path('data/prediction/step5_new_experiments/metrics/h16')).mkdir(parents=True, exist_ok=True)
